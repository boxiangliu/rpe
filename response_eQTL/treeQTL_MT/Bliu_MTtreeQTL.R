...
# Directories:
rasqual_fn_glucose='/srv/persistent/bliu2/rpe/processed_data/rasqual/output/glucose/joint/all_associations_filt.txt.gz'
out_dir_glucose='/srv/persistent/bliu2/rpe/processed_data/rasqual/output/glucose/treeQTL/'
rasqual_fn_galactose='/srv/persistent/bliu2/rpe/processed_data/rasqual/output/galactose/joint/all_associations_filt.txt.gz'
out_dir_galactose='/srv/persistent/bliu2/rpe/processed_data/rasqual/output/galactose/treeQTL/'
out_dir='/srv/persistent/bliu2/rpe/processed_data/response_eQTL/treeQTL_MT/Bliu_MTtreeQTL/'
...
get_gene_map=function(gene_ids){
	...
	gencode=fread('grep -v "#" /srv/persistent/bliu2/shared/annotation/gtex/gencode.v19.genes.v6p.hg19.gtf')
...
# Read RASQUAL result: 
joint_glucose=fread(rasqual_fn_glucose, select = c(1,2,10,11,12), col.names=c('fid','sid','log10qval','chisq','pi'))
joint_galactose=fread(rasqual_fn_galactose, ,select = c(1,2,10,11,12), col.names=c('fid','sid','log10qval','chisq','pi'))
