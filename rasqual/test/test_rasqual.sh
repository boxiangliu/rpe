...
total ../processed_data/rasqual/test/total/chr22/ '2>' ../logs/rasqual/chr22/rasqual.chr22.{}.total.log ::: {1..50}
...
../processed_data/rasqual/expression/glucose.size_factors_gc.bin \
../data/genotype/asvcf/glucose/rpe.imputed.chr22.all_filters.vcf.new.gz \
ase ../processed_data/rasqual/test/ase/chr22/ '2>' ../logs/rasqual/chr22/rasqual.chr22.{}.log ::: {1..50}
echo 'end time' >> ../processed_data/rasqual/test/profile.txt
date >> ../processed_data/rasqual/test/profile.txt
...
../processed_data/rasqual/expression/glucose.size_factors_gc.bin \
../data/genotype/asvcf/glucose/rpe.imputed.chr22.all_filters.vcf.new.gz \
joint ../processed_data/rasqual/test/joint/chr22/ '2>' ../logs/rasqual/chr22/rasqual.chr22.{}.log ::: {1..50}
echo 'end time' >> ../processed_data/rasqual/test/profile.txt
date >> ../processed_data/rasqual/test/profile.txt
